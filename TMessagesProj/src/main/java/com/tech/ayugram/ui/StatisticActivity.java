...
import com.tech.ayugram.messenger.LruCache;
...
import com.tech.ayugram.tgnet.tl.TL_stats;
...
import com.tech.ayugram.ui.Cells.EmptyCell;
import com.tech.ayugram.ui.Cells.LoadingCell;
import com.tech.ayugram.ui.Cells.ManageChatTextCell;
import com.tech.ayugram.ui.Cells.ShadowSectionCell;
import com.tech.ayugram.ui.Cells.StatisticPostInfoCell;
import com.tech.ayugram.ui.Charts.BarChartView;
import com.tech.ayugram.ui.Charts.BaseChartView;
import com.tech.ayugram.ui.Charts.DoubleLinearChartView;
import com.tech.ayugram.ui.Charts.LinearBarChartView;
import com.tech.ayugram.ui.Charts.LinearChartView;
import com.tech.ayugram.ui.Charts.PieChartView;
import com.tech.ayugram.ui.Charts.StackBarChartView;
import com.tech.ayugram.ui.Charts.StackLinearChartView;
import com.tech.ayugram.ui.Charts.data.ChartData;
import com.tech.ayugram.ui.Charts.data.DoubleLinearChartData;
import com.tech.ayugram.ui.Charts.data.StackBarChartData;
import com.tech.ayugram.ui.Charts.data.StackLinearChartData;
import com.tech.ayugram.ui.Charts.view_data.ChartHeaderView;
import com.tech.ayugram.ui.Charts.view_data.LineViewData;
import com.tech.ayugram.ui.Charts.view_data.TransitionParams;
...
import com.tech.ayugram.ui.Components.FlatCheckBox;
...
public class StatisticActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private final ArrayList<MemberData> topMembersAll = new ArrayList<>();
    private final ArrayList<MemberData> topMembersVisible = new ArrayList<>();
    private final ArrayList<MemberData> topInviters = new ArrayList<>();
    private final ArrayList<MemberData> topAdmins = new ArrayList<>();
        ...
        recyclerListView.setOnItemLongClickListener((view, position) -> {
            if (position >= adapter.recentPostsStartRow && position <= adapter.recentPostsEndRow) {
                ...
                ItemOptions.makeOptions(this, view)
                    ...
                    .add(R.drawable.msg_msgbubble3, getString(R.string.ViewMessage), () -> {
                    ...
                    .setScrimViewBackground(recyclerListView.getClipBackground(view))
                    .show();
    ...
    class Adapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            if (viewType >= 0 && viewType <= 4) {
                ...
                v = new ShadowSectionCell(parent.getContext(), 12, 0);
            }
