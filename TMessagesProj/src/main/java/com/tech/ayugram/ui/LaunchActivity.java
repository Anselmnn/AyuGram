...
import static com.tech.ayugram.ui.Components.Premium.LimitReachedBottomSheet.TYPE_BOOSTS_FOR_USERS;
...
import com.tech.ayugram.messenger.AutoDeleteMediaTask;
import com.tech.ayugram.messenger.BackupAgent;
import com.tech.ayugram.messenger.BetaUpdate;
import com.tech.ayugram.messenger.BirthdayController;
import com.tech.ayugram.messenger.BotGuardHelper;
...
import com.tech.ayugram.messenger.ChannelBoostsController;
import com.tech.ayugram.messenger.ChatObject;
import com.tech.ayugram.messenger.ContactsController;
import com.tech.ayugram.messenger.ContactsLoadingObserver;
...
import com.tech.ayugram.messenger.FingerprintController;
import com.tech.ayugram.messenger.FlagSecureReason;
import com.tech.ayugram.messenger.GenericProvider;
...
import com.tech.ayugram.messenger.LocationController;
...
import com.tech.ayugram.messenger.OpenAttachedMenuBotReceiver;
import com.tech.ayugram.messenger.PushListenerController;
...
import com.tech.ayugram.messenger.SharedPrefsHelper;
import com.tech.ayugram.messenger.TopicsController;
...
import com.tech.ayugram.messenger.pip.PipActivityController;
import com.tech.ayugram.messenger.pip.activity.IPipActivity;
import com.tech.ayugram.messenger.pip.activity.IPipActivityHandler;
import com.tech.ayugram.messenger.pip.activity.IPipActivityListener;
import com.tech.ayugram.messenger.utils.FrameMetricsOverlayView;
import com.tech.ayugram.messenger.utils.LeakDetector;
import com.tech.ayugram.messenger.utils.WindowVisibilityManager;
import com.tech.ayugram.messenger.video.VideoAds;
import com.tech.ayugram.messenger.voip.VideoCapturerDevice;
import com.tech.ayugram.messenger.voip.VoIPGroupNotification;
import com.tech.ayugram.messenger.voip.VoIPPendingCall;
import com.tech.ayugram.messenger.voip.VoIPPreNotificationService;
...
import com.tech.ayugram.tgnet.tl.TL_forum;
...
import com.tech.ayugram.ui.ActionBar.BottomSheetTabsOverlay;
...
import com.tech.ayugram.ui.Cells.LanguageCell;
import com.tech.ayugram.ui.Components.ActivityWindowEmptyBackgroundDrawable;
import com.tech.ayugram.ui.Components.AlertsCreator;
import com.tech.ayugram.ui.Components.AppIconBulletinLayout;
import com.tech.ayugram.ui.Components.AttachBotIntroTopView;
import com.tech.ayugram.ui.Components.AudioPlayerAlert;
import com.tech.ayugram.ui.Components.BatteryDrawable;
import com.tech.ayugram.ui.Components.BlockingUpdateView;
...
import com.tech.ayugram.ui.Components.EmbedBottomSheet;
...
import com.tech.ayugram.ui.Components.GroupCallPip;
import com.tech.ayugram.ui.Components.JoinGroupAlert;
import com.tech.ayugram.ui.Components.LayoutHelper;
import com.tech.ayugram.ui.Components.PasscodeView;
import com.tech.ayugram.ui.Components.PasscodeViewDialog;
import com.tech.ayugram.ui.Components.PhonebookShareAlert;
import com.tech.ayugram.ui.Components.PipRoundVideoView;
import com.tech.ayugram.ui.Components.PipVideoOverlay;
import com.tech.ayugram.ui.Components.Premium.LimitReachedBottomSheet;
import com.tech.ayugram.ui.Components.Premium.boosts.BoostPagerBottomSheet;
import com.tech.ayugram.ui.Components.Premium.boosts.GiftInfoBottomSheet;
...
import com.tech.ayugram.ui.Components.SearchTagsList;
import com.tech.ayugram.ui.Components.ShareTopView;
import com.tech.ayugram.ui.Components.SharingLocationsAlert;
import com.tech.ayugram.ui.Components.SizeNotifierFrameLayout;
import com.tech.ayugram.ui.Components.StickerSetBulletinLayout;
import com.tech.ayugram.ui.Components.StickersAlert;
import com.tech.ayugram.ui.Components.TermsOfServiceView;
import com.tech.ayugram.ui.Components.TextStyleSpan;
import com.tech.ayugram.ui.Components.ThemeEditorView;
import com.tech.ayugram.ui.Components.UndoView;
import com.tech.ayugram.ui.Components.inset.WindowAnimatedInsetsProvider;
...
import com.tech.ayugram.ui.Components.voip.RTMPStreamPipOverlay;
import com.tech.ayugram.ui.Components.voip.VoIPHelper;
import com.tech.ayugram.ui.Gifts.GiftSheet;
import com.tech.ayugram.ui.Stars.ISuperRipple;
import com.tech.ayugram.ui.Gifts.AuctionJoinSheet;
import com.tech.ayugram.ui.Stars.StarGiftPreviewSheet;
...
import com.tech.ayugram.ui.Stars.SuperRipple;
...
import com.tech.ayugram.ui.Stories.LiveStoryPipOverlay;
...
//            dismissAllWeb();
        ...
        if ((flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
            if (intent != null && intent.getAction() != null && !restore) {
                ...
                } else if ("com.tech.ayugram.CREATE_STICKER_PACK".equals(intent.getAction())) {
                    try {
...
//                                                storyId = Utilities.parseInt(data.getQueryParameter("story"));
                                ...
                                try (Cursor cursor = getContentResolver().query(intent.getData(), null, null, null, null)) {
                                    if (cursor != null) {
                                        if (cursor.moveToFirst()) {
                                            ...
                                            if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.com.tech.ayugram.android.call")) {
                                                audioCallUser = true;
                                            } else if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.com.tech.ayugram.android.call.video")) {
                                                videoCallUser = true;
                                            }
                                        }
                                    }
                ...
                } else if (intent.getAction().equals("com.tech.ayugram.OPEN_ACCOUNT")) {
                    open_settings = 1;
