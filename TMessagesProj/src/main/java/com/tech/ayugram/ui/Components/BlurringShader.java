...
public class BlurringShader {
    ...
    public void draw(float[] oesMatrix, int texture, int textureWidth, int textureHeight) {
        ...
        com.tech.ayugram.ui.Components.Paint.Shader.SetColorUniform(p.gradientTopHandle, gradientTop);
        com.tech.ayugram.ui.Components.Paint.Shader.SetColorUniform(p.gradientBottomHandle, gradientBottom);
