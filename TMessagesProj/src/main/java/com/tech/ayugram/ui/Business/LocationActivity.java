...
import com.tech.ayugram.ui.Components.ClipRoundedDrawable;
...
public class LocationActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void showLocationAlert() {
        com.tech.ayugram.ui.LocationActivity fragment = new com.tech.ayugram.ui.LocationActivity(ChatAttachAlertLocationLayout.LOCATION_TYPE_BIZ);
        if (geo != null) {
