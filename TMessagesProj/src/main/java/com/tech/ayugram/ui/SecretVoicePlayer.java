...
public class SecretVoicePlayer extends Dialog {
    ...
    public SecretVoicePlayer(Context context) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(windowView, (v, i) -> {
