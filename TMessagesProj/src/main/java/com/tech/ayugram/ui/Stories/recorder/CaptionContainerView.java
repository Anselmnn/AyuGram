...
import com.tech.ayugram.ui.Components.CaptionPhotoViewer;
...
import com.tech.ayugram.ui.Components.blur3.StrokeDrawable;
...
public class CaptionContainerView extends FrameLayout {
    ...
    public static class PeriodDrawable extends Drawable {
        ...
        public void draw(@NonNull Canvas canvas, float alpha) {
            ...
            strokePaint.setAlpha((int) (Color.alpha(strokeColor) * alpha * (1f - fillT)));
            ...
            textDrawable.setAlpha((int) (Color.alpha(strokeColor) * alpha));
