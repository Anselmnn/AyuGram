...
import static com.tech.ayugram.messenger.LocaleController.formatPluralSpannable;
...
import com.tech.ayugram.messenger.ringtone.RingtoneDataStore;
...
import com.tech.ayugram.ui.MultiLayoutTypingAnimator;
...
import com.tech.ayugram.ui.Components.FormattedDateSpan;
...
import com.tech.ayugram.ui.Components.QuoteSpan;
...
import com.tech.ayugram.ui.Components.SquigglyLinesSpan;
import com.tech.ayugram.ui.Components.Text;
import com.tech.ayugram.ui.Components.TextStyleSpan;
import com.tech.ayugram.ui.Components.TranscribeButton;
...
import com.tech.ayugram.ui.Components.URLSpanNoUnderlineBold;
...
import com.tech.ayugram.ui.PeerColorActivity;
    ...
    public static CharSequence formatRichBlock(TL_iv.PageBlock block, boolean isOut, boolean photoViewer, int maxLength, SpannableStringBuilder out, TL_iv.RichMessage richMessage) {
        if (
            ...
            if (document != null) {
                ...
                out.append(span("📎", R.drawable.msg_filled_data_files)).append(" ").append(TextUtils.isEmpty(name) ? getString(R.string.AttachDocument) : name);
            }
...
//        if (cachedSavedTimestamp != null) return cachedSavedTimestamp;
    ...
    public boolean isWelcomeAnchored() {
        return isWelcomeAnchored(messageOwner);
    }

    public boolean isEphemeralAndNotWelcome() {
        return isEphemeralAndNotWelcome(messageOwner);
    }

    public int getEphemeralId() {
        return isEphemeral() ? ephemeralMessageIdUnpack(messageOwner.id) : 0;
    }
